...
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/Harshadsshinde" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/harshad-shinde-359488353/" },
  { icon: Instagram, link: "https://www.instagram.com/harshad_shinde_28?igsh=MWJzZ21lN3E3bm5rMA==" }
];
...
const Home = () => {
  ...
  return (
    <div className="min-h-screen mb-0 bg-[#030014] overflow-hidden" id="Home">
      <div className={`relative z-10 transition-all duration-1000 ${isLoaded ? "opacity-100" : "opacity-0"}`}>
        <div className="container  px-[5%] mx-8 sm:px-6 lg:px-[0%] min-h-screen">
