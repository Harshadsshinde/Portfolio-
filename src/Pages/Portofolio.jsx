...
const techStacks = [
  ...
  { icon: "bootstrap.svg", language: "Mongodb" },
  { icon: "vercel.svg", language: "Vercel" },
  { icon: "ex1.png", language: "ExpressJS" },
  { icon: "gsap.jpg", language: "GSAP " },
  { icon: "frame.png", language: "Framer Motion" },
];
...
export default function FullWidthTabs() {
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="inline-block text-3xl mt-4 md:text-5xl font-bold text-center mx-auto text-transparent bg-clip-text bg-gradient-to-r from-[#6366f1] to-[#a855f7]">
          <span
            style={{
              color: "#6366f1",
              backgroundImage:
