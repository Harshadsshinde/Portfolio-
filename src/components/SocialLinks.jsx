...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/harshad-shinde-359488353/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "hats",
    icon: Instagram,
    url: "https://www.instagram.com/harshad_shinde_28?igsh=MWJzZ21lN3E3bm5rMA==",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "Github",
    icon: Github,
    url: "https://github.com/Harshadsshinde",
    color: "#ffffff",
  ...
  },
  {
    name: "TikTok",
    displayName: "Email",
    subText: "harshads1433@gmail.com",
    icon: ({ className, ...props }) => (
        <svg width="24px" height="24px" viewBox="0 0 45 45" xmlns="http://www.w3.org/2000/svg">
          <image href="./mailq.jpg" width="100%" height="100%" />
        </svg>
      ),
      
    
    url: "mailto:harshads1433@gmail.com",
    color: "white",
